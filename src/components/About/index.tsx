      ...
      <div>
        ...
        <AboutDescriptionContainer>
          <AboutDescription>
            ...
            a inovação tecnológica. Em um ambiente futurista, nossos cardápios
          ...
          <AboutDescription>
            Na cozinha, nossos chefs trabalham em colaboração com robôs
            culinários e inteligência artificial para garantir a perfeição em
            cada prato.
          </AboutDescription>
          ...
          <AboutDescription>
            ...
            fusão única entre tradição e inovação, proporcionando uma
            experiência gastronômica excepcional. Venha nos visitar e descubra
            como a tecnologia eleva a culinária oriental a novas alturas.
          </AboutDescription>
        </AboutDescriptionContainer>
      </div>
